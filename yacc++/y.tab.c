...
static const char *const yytname[] =
{
  ...
  "DIV", "LPAREN", "RPAREN", "UMINUS", "NUMBER", "';'", "$accept", "lines",
  "expr", YY_NULLPTR
};
...
{
      -5,     0,    -5,    16,    16,    -5,    -5,    13,    -5,    24,
      16,    16,    16,    16,    -5,    -5,    -4,    -4,    -5,    -5
};
...
{
       2,    12,    13,     0,     3,     8,     9,     4,     0,     0,
       5,     6,    16,    17,    18,    19,    10,    11,    12,    13,
       3,     0,     0,     4,    14,     0,     5,    10,    11,    12,
      13,     0,    15
};
...
#line 36 "expr.y"
                               { printf("%s\n", yyvsp[-1]); free(yyvsp[-1]); yyvsp[-1]=NULL; }
#line 1151 "y.tab.c"
    break;

  case 5: /* expr: expr ADD expr  */
#line 41 "expr.y"
                                            { yyval=strcatall("+",yyvsp[-2],yyvsp[0]); free(yyvsp[-2]); free(yyvsp[0]); yyvsp[-2]=yyvsp[0]=NULL; }
#line 1157 "y.tab.c"
    break;
...
#line 45 "expr.y"
                                            { yyval=yyvsp[-1]; yyvsp[-1]=NULL; }
#line 1181 "y.tab.c"
    break;

  case 10: /* expr: MINUS expr  */
#line 46 "expr.y"
                                            { yyval=strcatall("-",yyvsp[0],""); free(yyvsp[0]); yyvsp[0]=NULL; }
#line 1187 "y.tab.c"
    break;

  case 11: /* expr: NUMBER  */
#line 47 "expr.y"
                                            { yyval=yyvsp[0]; yyvsp[0]=NULL; }
#line 1193 "y.tab.c"
    break;
